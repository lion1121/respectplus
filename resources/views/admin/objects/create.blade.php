...
@section('content')
    ...
    <div class="row d-flex align-items-lg-top">
        <div class=" col-12">
            ...
            <div class="form-group row">
                {!! Form::label('lgFormGroupInput','Месторасположение объекта', ['class' => 'col-sm-4 col-form-label col-form-label-lg']) !!}
                <div class="col-sm-6 position-relative">
            ...
            <div class="form-group row">
                {!! Form::label('lgFormGroupInput','Заголовок', ['class' => 'col-sm-4 col-form-label col-form-label-lg']) !!}
                <div class="col-sm-6 position-relative">
                    {!! Form::text('title',null,['class'=>'form-control form-control-lg d-inline-block']) !!}
                </div>
            </div>
            <div class="form-group row">
                {!! Form::label('lgFormGroupInput','Текс объяления', ['class' => 'col-sm-4 col-form-label col-form-label-lg']) !!}
                <div class="col-sm-6 position-relative">
        ...
        {{--<div class="d-none add_type">{!! Form::open(['method'=>'POST', 'action'=>['AdminTypeController@store']]) !!}--}}
        {{--<div class="form-group row">--}}
        ...
        {{--{!! Form::close() !!}--}}
        {{--</div>--}}
        {{--<div class="d-none add_place">{!! Form::open(['method'=>'POST', 'action'=>['AdminPlaceController@store']]) !!}--}}
        {{--<div class="form-group row">--}}
